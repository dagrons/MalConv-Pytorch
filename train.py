...
if model_name == "malconv":
    ...
    model = RCNN(embed_dim, out_channels, window_size, hidden_size, num_layers, bidirectional, residual, enable_dos_mask=enable_dos_mask)
    ...
    model = AttentionRCNN(embed_dim, out_channels, window_size, hidden_size, num_layers, bidirectional, attn_size,
                          residual, enable_dos_mask=enable_dos_mask)
